    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class=" form">
                    <form class="cmxform form-horizontal "  method="POST" action="{{ route('combo.them-moi')}}" enctype="multipart/form-data" novalidate="novalidate">
                        @csrf
                        <div class="form-group ">
                            <label for="cname" class="control-label col-lg-3">Avatar</label>
                            <div class="col-lg-6">
                                <input type="file" id="exampleInputFile" name="avatar_url">
                            </div>
                        </div>
                        <div class="form-group ">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control " id="curl" type="url" name="gia_khuyen_mai">
                            </div>
                        </div>
                        <div class="form-group ">
